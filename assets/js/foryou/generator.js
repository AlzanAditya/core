document.getElementById('foryou-form').addEventListener('submit', async function (e) {
    ...
    */
    ...
    setTimeout(() => {
        document.getElementById('info').innerHTML = "Pesan kamu sedang diproses dan akan segera tersedia di: <br><b>zanxa.studio/foryou/" + data.sublink + "</b><br>Silakan cek dalam 2 menit.";
    }, 2000);
});
